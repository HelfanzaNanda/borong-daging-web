<div class="sub-header">
    ...
    <div class="header_cart order-1">
      <a href="#" class="cart__btn hover-btn pull-bs-canvas-left" title="Cart"><i class="uil uil-shopping-cart-alt"></i><span>Cart</span><ins>{{Session::get('_cart') ? Session::get('_cart_total') : 0}}</ins><i class="uil uil-angle-down"></i></a>
    </div>
