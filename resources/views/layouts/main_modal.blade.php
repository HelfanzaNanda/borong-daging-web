...
<div class="bs-canvas bs-canvas-left position-fixed bg-cart h-100">
  <div class="bs-canvas-header side-cart-header p-3 ">
    <div class="d-inline-block  main-cart-title">Keranjang
      <span>{{App\Models\Carts::where('user_id', Session::get('_id'))->count()}} Barang</span></div>
    ...
    <div class="side-cart-items">
      ...
      <div class="cart-item">
        <div class="cart-product-img">
          <img
            src="{{ env('IMAGE_URL').'/storage/app/public/'.$row['meat_for_sale']['media']['id'].'/'.$row['meat_for_sale']['media']['file_name'] }}"
            alt="">
...
<div id="login_modal" class="header-cate-model main-gambo-model modal fade" tabindex="-1" role="dialog"
  aria-modal="false">
  <div class="modal-dialog category-area" role="document">
    <div class="category-area-inner">
      <div class="modal-header">
                  ...
                  <div class="sign-inner">
                    <div class="sign-logo" id="logo">
                      ...
                      <a href="index.html"><img class="logo-inverse"
                          src="{{ asset('assets/images/BORONG-DAGING-LOGO.png') }}" alt=""></a>
                    </div>
                    <div class="form-dt">
...
<div id="register_modal" class="header-cate-model main-gambo-model modal fade" tabindex="-1" role="dialog"
  aria-modal="false">
  <div class="modal-dialog category-area" role="document">
    <div class="category-area-inner">
      <div class="modal-header">
                    ...
                    <div class="form-dt">
                      <div class="form-inpts checout-address-step">
                        <form id="form-register" autocomplete="off">
                          ...
                          <div class="form-group pos_rel">
                            <input id="phone" name="phone" type="tel" placeholder="Enter Phone"
                              class="form-control lgn_input" required="">
